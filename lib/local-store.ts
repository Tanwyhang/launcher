...
function normalizeAffiliateLink(raw: unknown, index: number): AffiliateLinkDraft {
  ...
  return {
    ...
    displayedPrice: typeof candidate.displayedPrice === "string" ? candidate.displayedPrice : "",
    pricingSummary: typeof candidate.pricingSummary === "string" ? candidate.pricingSummary : "",
    commissionRate: typeof candidate.commissionRate === "number" ? candidate.commissionRate : undefined,
